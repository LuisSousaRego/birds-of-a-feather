...
pub const BIRD_VIEW_DISTANCE: f32 = 10.0;

pub const BIRD_SEPARATION_FACTOR: f32 = 2.0;
pub const BIRD_ALIGNMENT_FACTOR: f32 = 0.1;
pub const BIRD_COHESION_FACTOR: f32 = 0.01;
pub const BIRD_ATTACK_FACTOR: f32 = 0.1;
